...
class test_Data_CSV(TestCase):
    ...
    def test_csv_files(self):
        ...
        assert set(files) == { 'Resolver_Data.csv','Extract_AD.csv', 'Extract_DT.csv','Extract_Landesk.csv', 'Extract_AV.csv', 'Extract_Deskplan.csv', 'Tiny_Test_Data.csv', 'combined_records.csv'}
